@echo off
:: Check Windows version (Windows 10 21H2 minimum required)
...
for /f %%i in ('dir /b *NET.Native.Framework*1.7.appx 2^>nul ^| find /i "x64"') do set "Framework6X64=%%i"
for /f %%i in ('dir /b *NET.Native.Framework*1.7.appx 2^>nul ^| find /i "x86"') do set "Framework6X86=%%i"
...
for /f %%i in ('dir /b *NET.Native.Runtime*1.7.appx 2^>nul ^| find /i "x64"') do set "Runtime6X64=%%i"
for /f %%i in ('dir /b *NET.Native.Runtime*1.7.appx 2^>nul ^| find /i "x86"') do set "Runtime6X86=%%i"
...
for /f %%i in ('dir /b *VCLibs*14.00.Desktop.appx 2^>nul ^| find /i "x64"') do set "VCLibsUWPX64=%%i"
for /f %%i in ('dir /b *VCLibs*14.00.Desktop.appx 2^>nul ^| find /i "x86"') do set "VCLibsUWPX86=%%i"
...
set "DepStore=%VCLibsX64%,%VCLibsUWPX64%,%VCLibsX86%,%VCLibsUWPX86%,%Framework6X64%,%Runtime6X64%,%Framework6X86%,%Runtime6X86%,%FrameworkII6X64%,%FrameworkII6X86%,%RuntimeII6X64%,%RuntimeII6X86%"
set "DepPurchase=%VCLibsX64%,%VCLibsUWPX64%,%VCLibsX86%,%VCLibsUWPX86%,%Framework6X64%,%Runtime6X64%,%RuntimeII6X64%,%FrameworkII6X64%,%RuntimeII6X86%,%FrameworkII6X86%,%Framework6X86%,%Runtime6X86%"
set "DepXbox=%VCLibsX64%,%VCLibsUWPX64%,%VCLibsX86%,%VCLibsUWPX86%,%Framework6X64%,%Runtime6X64%,%RuntimeII6X64%,%FrameworkII6X64%,%RuntimeII6X86%,%FrameworkII6X86%,%Framework6X86%,%Runtime6X86%"
set "DepInstaller=%VCLibsX64%,%VCLibsUWPX64%,%VCLibsX86%,%VCLibsUWPX86%"
...
echo.
echo ============================================================
echo Error: Windows 10 21H2 (version 19044 or later) required
echo ============================================================
echo.
echo Press any key to exit.
pause >nul
